...
var Aladin = function () {
  ...
  Aladin.prototype.getViewDataURL = function (optionsa) {
    var options = optionsa || {}; // support for old API signature
...
Aladin.prototype.getEmbedCode = function () {
  ...
  s += 'var aladin = aladin("#aladin-lite-div", {survey: "' + survey + 'P/DSS2/color", fov: ' + fov.toFixed(2) + ', target: "' + coo.format("s") + '"});\n';
  s += "</script>";
  return s;
}; // @API
...
Aladin.prototype.displayFITS = function (url, options, successCallback, errorCallback) {
  ...
  var self = this; // I don't know who trigger this function, so I can't test this is working
  ...
  fetch("https://alasky.unistra.fr/cgi/fits2HiPS", {
    ...
    self.setOverlayImageLayer(self.createImageSurvey(label, label, data.data.url, "equatorial", meta.max_norder, {
      imgFormat: "png"
    }));
