...
export function generateDiffReport(currInput, baseInput) {
    ...
    const status = filesDiffReport.status === Status.Fail || groupsDiffReport.status === Status.Fail ? Status.Fail : Status.Pass;
