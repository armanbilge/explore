...
export default class Polyline {
  ...
  draw(ctx, projection, frame, width, height, largestDim, zoomFactor) {
    ...
    for (var _k = 1; _k < this.radecArray.length; _k++) {
      pt = AladinUtils.radecToViewXy(this.radecArray[_k][0], this.radecArray[_k][1], projection, frame, width, height, largestDim, zoomFactor);
