...
var Popup = function () {
  // constructor
  var Popup = function Popup(parentDiv, view) {
    ...
    var domPopupLink = document.createElement("a");
    domPopupLink.classList.add("aladin-closeBtn");
    domPopupLink.textContent = "x"; // close popup

    var self = this;
    domPopupLink.addEventListener('click', function () {
      self.hide();
    }, false);
