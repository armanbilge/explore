...
const output = {
    name: NAME,
    create: ({ options }) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const customOutput = yield Promise.resolve(`${resolvedPath}`).then(s => __importStar(require(s)));
        ...
        return {
            generate: (report) => __awaiter(void 0, void 0, void 0, function* () {
                yield customOutput.default(report);
            }),
        };
    }),
};
