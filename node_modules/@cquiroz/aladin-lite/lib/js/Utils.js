 ...
 *****************************************************************************/
var Utils = {};
var JSONP_PROXY = "https://alasky.unistra.fr/cgi/JSONProxy";
...
function relMouseCoords(event) {
  if (event.offsetX) {
    ...
    var e = event; // http://www.jacklmoore.com/notes/mouse-position/
...
Utils.loadFromMirrors = function (urls, options) {
  ...
  if (urls.length === 0) {
    ...
    var url = new URL(ajaxOptions.url);
